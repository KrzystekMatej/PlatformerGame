...
namespace FibonacciHeap
{
    ...
    public class FibonacciHeap<T, TKey> : IEnumerable<FibonacciHeapNode<T, TKey>>
        where TKey : IComparable<TKey>
    {
        ...
        public IEnumerator<FibonacciHeapNode<T, TKey>> GetEnumerator()
        {
            ...
            while (stack.Count > 0)
            {
                ...
                FibonacciHeapNode<T, TKey> child = current.Child;
                if (child != null)
                {
                    FibonacciHeapNode<T, TKey> startChild = child;
                    do
                    {
                        stack.Push(child);
                        child = child.Right;
